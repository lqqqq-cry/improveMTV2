...
- For example: `sudo ./generate.sh 0.01 ~/Downloads/data/SF0.01`
- Output:
...
# Dont forget modify the code `fin.open("/home/lia/Downloads/data/SF0.01/lineorder.tbl");` to the path to the fact table in line 567 in utilities.cpp.
